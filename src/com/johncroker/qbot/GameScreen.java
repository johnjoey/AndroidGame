...
import com.johncroker.framework.Game;
import com.johncroker.framework.Graphics;
import com.johncroker.framework.Image;
import com.johncroker.framework.Input.TouchEvent;
...
public class GameScreen extends Screen {
	...
	private void loadMap() {
		...
		Scanner scanner = new Scanner(QbotGame.map);
	...
	private void drawRunningUI() {
		Graphics g = game.getGraphics();
		g.drawImage(Assets.button, 0, 180, 0, 0, 65, 65);
		g.drawImage(Assets.button, 0, 245, 0, 65, 65, 65);
		g.drawImage(Assets.button, 0, 310, 0, 130, 65, 65);
